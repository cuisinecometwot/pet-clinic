...
if ($objectType === 'health_record') {
    $redirectUrl = '../Dashboard.php?p=bookingManager/healthServiceManager';
} elseif ($objectType === 'beauty_service') {
    $redirectUrl = '../Dashboard.php?p=bookingManager/spaManager';
} elseif ($objectType === 'hotel_record') {
    $redirectUrl = '../Dashboard.php?p=bookingManager/hotelRecordManager';
} else {
