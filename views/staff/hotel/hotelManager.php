...
<head>
    ...
    <link rel="stylesheet" href="staff/hotel/style.css">
</head>
<body>
    <div class="container">
        <h1>Pet Hotel</h1>
            ...
            <?php
                ...
                if ($num > 0) {
                    ...
                    while ($row = pg_fetch_assoc($result)) {
                        ...
                        echo "<a href='Dashboard.php?p=staff/hotel/modify_room&object_id={$room->getId()}&object_type=hotel_record' style='text-decoration: none; color: inherit;'>";
