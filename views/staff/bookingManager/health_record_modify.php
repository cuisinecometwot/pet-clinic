...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $newVeterinarian = $_POST['veterinarian'] ? $_POST['veterinarian'] : null;
    ...
    if ($updateResult) 
    {
        ...
        header("Location: ../../Dashboard.php?p=staff/bookingManager/healthServiceManager");
        exit();
    } else 
    {
...
<body>
    <div class="container">
        <div class="details">
            ...
            <form method="POST" action="staff/bookingManager/health_record_modify.php">
