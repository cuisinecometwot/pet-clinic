<h3>Add Staff</h3>
<form action="admin/userManager/add_staff.php" method="POST">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['staffEmail']) && isset($_POST['staffPassword'])) {
        ...
        if (pg_num_rows($checkLoginResult) > 0) {
            ...
            header("Location: ../../Dashboard.php?p=admin/userManager/add_staff");
            exit();
        }
        ...
        header("Location: ../../Dashboard.php?p=admin/userManager/users");
        exit();
    } else {
