  	...
  	if (count($services) > 0) 
  	{
    	foreach ($services as $service) 
    	{
    		echo '<div class="card mb-3">';
      		...
      		echo '<p class="card-text"><b>Cost:</b> VND' . $service['cost'] . ' per day</p>';

      		// Add an edit button if editing functionality is desired (optional)
      		// echo '<a href="services.php?edit=' . $service['sid'] . '" class="btn btn-primary">Edit</a>';
